...
const Halo = ({ isAnimating, onAnimationEnd }) => (
  <svg
      ...
      role="presentation">
      <g fill="none">
        <path className={styles.halo5} d="M45.642 26.843c0-.04 0-.08-.002-.122a1.462 1.462 0 0 1 1.346-1.48l4.334-.346a1.646 1.646 0 0 1 1.773 1.612c.001.123.003.246.003.37a1.643 1.643 0 0 1-1.732 1.652l-4.342-.24a1.46 1.46 0 0 1-1.38-1.446" fill="#7460E1"/>
        <path className={styles.halo4} d="M40.242 13.543a4.137 4.137 0 0 0-.087-.085 1.462 1.462 0 0 1-.095-1.998l2.82-3.31a1.646 1.646 0 0 1 2.393-.113c.088.086.176.17.264.258.674.666.65 1.763-.056 2.394l-3.24 2.9a1.46 1.46 0 0 1-2-.046" fill="#C454FF"/>
        <path className={styles.halo3} d="M27.02 7.957l-.122.001a1.462 1.462 0 0 1-1.48-1.345l-.346-4.334A1.646 1.646 0 0 1 26.683.506c.123-.002.246-.004.37-.004a1.643 1.643 0 0 1 1.653 1.732l-.24 4.342a1.46 1.46 0 0 1-1.447 1.38" fill="#83FFCD"/>
        <path className={styles.halo2} d="M13.72 13.356a4.137 4.137 0 0 0-.085.087 1.462 1.462 0 0 1-1.999.096l-3.309-2.82a1.646 1.646 0 0 1-.114-2.394c.086-.088.171-.176.26-.264a1.643 1.643 0 0 1 2.393.056l2.9 3.24a1.46 1.46 0 0 1-.046 2" fill="#FFE100"/>
        <path className={styles.halo1} d="M8.133 26.579c0 .04 0 .08.002.122a1.462 1.462 0 0 1-1.346 1.48l-4.334.346a1.646 1.646 0 0 1-1.773-1.612c-.001-.123-.004-.246-.004-.37a1.643 1.643 0 0 1 1.733-1.652l4.342.24a1.46 1.46 0 0 1 1.38 1.446" fill="#DC352C"/>
      </g>
  </svg>
);
    ...
    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g transform="translate(3.000000, 3.000000)" fillRule="nonzero">
        ...
        <g transform="translate(8.520000, 8.756020)" fill="#C3C3C3">
          <path className={styles.check} d="M6.71389301,4.03725727 L8.85939217,4.03725727 C9.40526918,4.03725727 9.84778993,4.47977802 9.84778993,5.02565503 C9.84778993,5.57153204 9.40526918,6.01405279 8.85939217,6.01405279 L6.71389301,6.01405279 L6.71389301,8.15955193 C6.71389301,8.885195 6.12564307,9.47344494 5.4,9.47344494 C4.67435693,9.47344494 4.08610699,8.885195 4.08610699,8.15955193 L4.08610699,6.01405279 L1.94060787,6.01405279 C1.39473119,6.01405279 0.952210074,5.57153235 0.952210074,5.02565503 C0.952210074,4.47977771 1.39473119,4.03725727 1.94060787,4.03725727 L4.08610699,4.03725727 L4.08610699,1.89175813 C4.08610699,1.16611506 4.67435693,0.577865119 5.4,0.577865119 C6.12564307,0.577865119 6.71389301,1.16611506 6.71389301,1.89175813 L6.71389301,4.03725727 Z M4.82424913,4.1244089 L5.97575087,4.1244089 L5.97575087,5.92690116 L4.82424913,5.92690116 L4.82424913,4.1244089 Z" />
        </g>
      </g>
    </g>
  </svg>
