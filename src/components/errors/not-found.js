...
<svg viewBox="0 0 88 86" xmlns="http://www.w3.org/2000/svg">
<g transform="translate(1 1)" fill="none" fill-rule="evenodd">
    <path d="M75.488 13.541C79.911 16.924 85.7 30.651 85.7 41.215c0 23.527-19.073 42.6-42.6 42.6S.5 64.742.5 41.215c0-9.341.835-14.852 5.894-21.888a119.629 119.629 0 0 1 4.27-5.542c4.146-.137 7.976.058 11.491.585 10.48 1.57 18.045 8.53 30.453 8.53 12.408 0 22.954-9.203 22.88-9.359z" fill="#617AEB" fill-rule="nonzero" />
    <path d="M10.663 13.785c4.147-.137 6.104-.353 11.492.585 9.612 1.673 18.045 8.53 30.453 8.53 12.408 0 22.954-9.203 22.88-9.359" stroke="#000" stroke-width="2" fill-rule="nonzero" />
    <g transform="translate(.4 .3)" stroke="#000" stroke-width="2">
        <rect x="11.25" width="62.7" height="6.3" rx="3.15" />
        <path d="M42.599 83.106c-14.047 0-26.558-7.034-34.067-17.538-.103-.144 68.134 0 68 .187-7.603 10.512-19.97 17.351-33.933 17.351z" fill="#FFF399" fill-rule="nonzero" />
    ...
    <g transform="translate(20 68)" fill="#000" fill-rule="nonzero" stroke="#000" stroke-width=".938">
    ...
    <g className="treasure-chest" transform="translate(12.5 45.2)" fill-rule="nonzero" stroke="#000">
        <g className="treasure-chest-bottom" transform="translate(0 10.047)" stroke-width="2">
        ...
        <g className="treasure-chest-top" stroke-width="2">
        ...
        <g className="coins" transform="translate(3.127 5.795)" fill="#FFE100" stroke-width="1.5">
            <path d="M9.95 3.162a3.162 3.162 0 1 0-6.325 0" />
            <path d="M11.548 3.51a2.536 2.536 0 0 0-4.923-.01" id="Shape-Copy-2" />
            <path d="M15.835 3.804a2.535 2.535 0 1 0-5.07 0" id="Shape-Copy-3" />
            <path d="M5.07 3.51a2.535 2.535 0 0 0-5.07 0" id="Shape" />
        </g>
    </g>
</g>
</svg>
