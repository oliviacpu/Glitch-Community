...
export const Aquarium = ({ className }) => (
  ...
  xmlns="http://www.w3.org/2000/svg">
    <g transform="translate(1 1)" fill="none" fillRule="evenodd">
        <path d="M75.488 13.541C79.911 16.924 85.7 30.651 85.7 41.215c0 23.527-19.073 42.6-42.6 42.6S.5 64.742.5 41.215c0-9.341.835-14.852 5.894-21.888a119.629 119.629 0 0 1 4.27-5.542c4.146-.137 7.976.058 11.491.585 10.48 1.57 18.045 8.53 30.453 8.53 12.408 0 22.954-9.203 22.88-9.359z" fill="#617AEB" fillRule="nonzero" />
        <path d="M10.663 13.785c4.147-.137 6.104-.353 11.492.585 9.612 1.673 18.045 8.53 30.453 8.53 12.408 0 22.954-9.203 22.88-9.359" stroke="#000" strokeWidth="2" fillRule="nonzero" />
        <g transform="translate(.4 .3)" stroke="#000" strokeWidth="2">
            <rect x="11.25" width="62.7" height="6.3" rx="3.15" />
            <path d="M42.599 83.106c-14.047 0-26.558-7.034-34.067-17.538-.103-.144 68.134 0 68 .187-7.603 10.512-19.97 17.351-33.933 17.351z" fill="#FFF399" fillRule="nonzero" />
