...
module.exports = function(external) {
  ...
  async function render(req, res, { title, description, image = imageDefault, socialTitle, canonicalUrl = APP_URL }) {
    let built = true;
  ...
  app.get('/create', async (req, res) => {
    ...
    await render(req, res, { title, description, image, socialTitle, canonicalUrl });
  });
